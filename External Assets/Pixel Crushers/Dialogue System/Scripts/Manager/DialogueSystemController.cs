...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class DialogueSystemController : MonoBehaviour
    {
        ...
        public delegate void OnEndEventConversation();
        public static event OnEndEventConversation onEndEventConversation;
