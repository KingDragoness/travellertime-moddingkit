...
namespace TestingTesting.Quests
{
    public class QuestScript_PreciousRing : QuestObject
    {
        ...
        {
            print("Quest done");
            DestinyInternalCommand.instance.Quest_SetStage("vanilla", "Misc_PreciousRing", 10);
        ...
        private void CompleteQuest_GiveFakeRing()
        {
            ...
            DestinyInternalCommand.instance.Quest_SetStage("vanilla", "Misc_PreciousRing", 11);
