...
namespace Traveller_of_Time_Mod_Tools.Generated
{
    using UMod.Shared;
    ...
    public class ModToolsMenu
    {
        ...
        [UnityEditor.MenuItem("Mod Tools/Game Assets (Experimental)", priority=110)]
        ...
        [UnityEditor.MenuItem("Mod Tools/Modpack Edit", priority=111)]
        internal static void Menu_Modpack_Edit()
        {
            // Failed to generate method body. WindowType was null and no further code will be generated to avoid error
        }
    }
}
